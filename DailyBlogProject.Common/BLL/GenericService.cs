...
namespace DailyBlogProject.Common.BLL
{
    using DAL;
    using Response;
    public class GenericService<D, T> : InterfaceGenericService<T> where T : class where D : InterfaceGenericRepo<T>, new()
    {
        #region -- Implements --
        ...
        MultipleResponse InterfaceGenericService<T>.Read(string code)
        {
            throw new NotImplementedException();
        }

        MultipleResponse InterfaceGenericService<T>.Delete(string code)
        {
            throw new NotImplementedException();
        }
